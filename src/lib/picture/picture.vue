  ...
  <div ref="container" id="picture-input" class="picture-input">
    ...
    <div v-else-if="supportsPreview">
      <div class="preview-container"
        :style="{height: previewHeight + 'px', borderRadius: radius + '%'}">
    ...
    <div v-else>
      <md-button v-if="!imageSelected" @click.prevent="selectImage" :class="buttonClass">{{ strings.select }}</md-button>
      <div v-else>
        <div v-html="strings.selected"></div>
        <md-button v-if="!hideChangeButton" @click.prevent="selectImage" :class="buttonClass">{{ strings.change }}</md-button>
        <md-button v-if="removable" @click.prevent="removeImage" :class="removeButtonClass">{{ strings.remove }}</md-button>
      </div>
    </div>
