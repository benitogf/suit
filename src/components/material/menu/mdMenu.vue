...
<script>
  import transitionEndEventName from '@/components/material/core/utils/transitionEndEventName'
  import getInViewPosition from '@/components/material/core/utils/getInViewPosition'
  ...
  export default {
    ...
    mounted () {
      this.$nextTick(() => {
        ...
        this.backdropElement = this.$refs.backdrop && this.$refs.backdrop.$el
        this.validateMenu()
    ...
    beforeDestroy () {
      ...
      if (this.toggle && this.menuTrigger) {
